...
<p><span style="font-size: 14pt;">Given an integer <strong>n</strong>, compute the sum of all natural numbers from 1 to n (inclusive). If n is 0, the sum should be 0.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong></span><br /><span style="font-size: 14pt;">0 &le; n &le; 10<sup>4</sup><br /></span></p>